...
namespace ProjectDelta
{
    public class Level1
    {
        ...
        private Texture2D mathHeroCharacter;
        ...
        private Vector2 movingmathHeroCharacterPosition;
        ...
        {
            background = content.Load<Texture2D>("resized_level1_background");

            //Play music in repeating loop
            Song backgroundMusic;
            backgroundMusic = content.Load<Song>("level1_background_music");
            MediaPlayer.Play(backgroundMusic);
            MediaPlayer.IsRepeating = true;

            mathHeroCharacter = content.Load<Texture2D>("math_hero_character");
            ...
            movingmathHeroCharacterPosition = new Vector2(-200 * scale, 500 * scale);
        ...
        public bool Update(GameTime gameTime)
        {
            ...
            movingmathHeroCharacterPosition.X -= (float)(planetSpeed * 100 * Math.Sin((double)gameTime.ElapsedGameTime.TotalMilliseconds) * MathHelper.Pi / 2);
            movingmathHeroCharacterPosition.Y += planetSpeed * (float)gameTime.ElapsedGameTime.TotalMilliseconds;
        ...
        public void Draw(SpriteBatch spriteBatch)
        {
            ...
            spriteBatch.Draw(mathHeroCharacter, movingmathHeroCharacterPosition, null, Color.White, 0f, Vector2.Zero, scale, SpriteEffects.None, 0f);
